...
export default async function CurrentSlugPage({ params }: DocsPageProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
      <article className="col-span-1 md:col-span-2 prose prose-neutral dark:prose-invert py-3 ">
        <h1>{currentDoc.title}</h1>
        <Mdx code={currentDoc.body.code} />
        <DocsPager doc={currentDoc} />
      </article>
      <div className="col-span-1 fixed top-14 z-30 ml-2 hidden h-[calc(100vh-3.5rem)] w-full shrink-0 md:sticky md:block py-2">
