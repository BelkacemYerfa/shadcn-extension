...
const examples: Registry = [
  {
    ...
    files: [
      {
        path: "example/timeline/timeline-right.tsx",
        type: "components:example",
      },
    ],
  },
  {
    ...
    files: [
      {
        path: "example/timeline/timeline-alternate.tsx",
        type: "components:example",
      },
    ],
  },
  {
    ...
    files: [
      {
        path: "example/timeline/timeline-labels.tsx",
        type: "components:example",
      },
    ],
  },
