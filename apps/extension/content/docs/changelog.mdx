...
<Link target="_blank" href="https://x.com/dangling_hanma" className="font-semibold" >@Raphael</Link> for that...
...
Thanks to his big help and support of building the cli, and making the configuration for the end user as easy as possible, we want to welcome
@Raphael
to the team, and really this is just the beginning he has some big plans to make the experience even better.
...
<Alert className="mt-4" variant="info">
  ...
  <AlertDescription>
    ...
    <Link
      target="_blank"
      href="https://embla-carousel.com/api/options/#direction"
...
This is project is growing up, and this is cool to see from the community, but a lot of parts are missing, so I want you all to welcome a new team member <Link target="_blank" href="https://twitter.com/Soham_Asmi" className="font-semibold" >@Gaurang
</Link>, together, we feel confident that we can deliver the tools you need to easily build accessible modern UIs faster than ever before.
